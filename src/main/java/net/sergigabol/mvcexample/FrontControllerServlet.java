 ...
 */
package net.sergigabol.mvcexample;
...
import net.sergigabol.mvcexample.actions.Action;
import net.sergigabol.mvcexample.actions.ActionFactory;
...
public class FrontControllerServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        //decidir en funció de la request quina acció sobre el model s'ha de fer
